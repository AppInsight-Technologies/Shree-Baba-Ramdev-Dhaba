...
//Initialised as false, then assigned from get-restaurant api
  ...
  static bool isBulkUploadroot = false;
  ...
  static bool isLanguageModuleroot = false;
  static bool isPickupfromStore = false; //done
  static bool isShoppingList = false; //done
  static bool isMembership = false;
  static bool isMembershiproot = false;//done
  static bool isLoyalty = false; //done
  static bool isLoyaltyroot = false;
  static bool isReferEarn = false; //done
  static bool isReferEarnroot = false; //done
  static bool isPromocode = false; //done
  static bool isPushNotification = false;
  static bool isPushNotificationroot = false;
  static bool isOnBoarding = false; //done
  static bool isExpressDelivery = false; //done
  static bool isWallet = false; //done
  static bool isWalletroot = false;
  static bool isLiveChat = true;
  static bool isLiveChatroot = true;//done
  static bool isWhatsapp = false;
  static bool isWhatsapproot = false;//done
  ...
  static bool isSubscriptionroot = true;//done
