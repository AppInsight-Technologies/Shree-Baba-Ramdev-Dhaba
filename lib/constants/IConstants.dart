...
class IConstants {
  ...
  static String APP_NAME = "Shree Baba Ramdev Dhaba";
  static String APP_NAME1 = "Shree Baba Ramdev Dhaba";
  ...
  static String refIdForMultiVendor = "1124";
