...
Future<void> main() async {
  ...
  if (!PrefUtils.prefs!.containsKey("branch"))
    //PrefUtils.prefs!.setString("branch", "999");
    PrefUtils.prefs!.setString("branch", "64");
...
class MyApp extends StatelessWidget with Navigations {
  ...
  Widget build(BuildContext context) {
    ...
    final _router = GoRouter(
      ...
      initialLocation: Vx.isWeb
          ? "/store/" + nUri(Routename.Home).path
          : "/store/${nUri(Routename.Splash).path}",
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider.value(value: unavailabilities()),
          ChangeNotifierProvider.value(value: FeaturedCategoryList()),
        ...
        child: VxBuilder<GroceStore>(
            ...
            builder: (BuildContext context, store, VxStatus? status) {
              return MaterialApp.router(
                ...
                builder: (context, child) {
                  ...
                  return MediaQuery(
                    child: Directionality(
                        textDirection: !Vx.isWeb
                            ? store.language.language.code == "ar"
                                ? TextDirection.rtl
                                : TextDirection.ltr
                            : TextDirection.ltr,
                        child: child!),
                ...
                theme: ThemeData(
                  primarySwatch: MaterialColor(0xff21A954, {
                    50: Color(0xff21A954),
                    100: Color(0xff21A954),
                    200: Color(0xff21A954),
                    300: Color(0xff21A954),
                    400: Color(0xff21A954),
                    500: Color(0xff21A954),
                    600: Color(0xff21A954),
                    700: Color(0xff21A954),
                    800: Color(0xff21A954),
                    900: Color(0xff21A954),
                  }),
                  accentColor: MaterialColor(0xff21A954, {
                    50: Color(0xff21A954),
                    100: Color(0xff21A954),
                    200: Color(0xff21A954),
                    300: Color(0xff21A954),
                  ...
                  textSelectionTheme: TextSelectionThemeData(
                      selectionColor: ColorCodes.baseColorlight),
