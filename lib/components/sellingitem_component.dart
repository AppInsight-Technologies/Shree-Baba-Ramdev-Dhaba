...
class _SellingItemsv2State extends State<SellingItemsv2> with Navigations {
  ...
  void initState() {
    ...
    productBox = /*Hive.box<Product>(productBoxName)*/ (VxState.store
    as GroceStore)
        .CartItemList;
    print("from screennn..." + widget.fromScreen.toString());
    ...
    try {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        if (PrefUtils.prefs!.containsKey("deliverylocation")) {
          ...
          Navigation(context,
              name: Routename.MapScreen, navigatore: NavigatoreTyp.Push);
        }
      }
      //Navigator.of(context).pop();
    } catch (error) {
    ...
    switch (result.status) {
      ...
      case FacebookLoginStatus.cancelledByUser:
        ...
        Fluttertoast.showToast(
            msg: S
                .of(context)
                .sign_in_cancelledbyuser, //"Sign in cancelled by user!",
            fontSize: MediaQuery.of(context).textScaleFactor * 13,
            backgroundColor: ColorCodes.blackColor,
            textColor: ColorCodes.whiteColor);
        //onLoginStatusChanged(false);
      ...
      case FacebookLoginStatus.loggedIn:
        ...
        PrefUtils.prefs!
            .setString('FirstName', profile['first_name'].toString());
    ...
    try {
      ...
      if (responseJson['type'].toString() == "old") {
        ...
        setState(() {
          ...
          if (PrefUtils.prefs!.getString('prevscreen') ==
              'signInAppleNoEmail') {
            email = "";
          } else {
  ...
  Future<void> appleLogIn() async {
    ...
    if (await SignInApple.canUseAppleSigin()) {
      ...
      SignInApple.handleAppleSignInCallBack(
          onCompleteWithSignIn: (AppleIdUser? appleidentifier) async {
              ...
              if (responseJson['type'].toString() == "old") {
                if (responseJson['data'] != "null") {
                  ...
                  if (responseJson['status'].toString() == "true") {
                    ...
                    PrefUtils.prefs!.setString("mobile", data['mobile'].toString());
                    PrefUtils.prefs!
                        .setString("latitude", data['latitude'].toString());
                    PrefUtils.prefs!
                        .setString("longitude", data['longitude'].toString());

                    PrefUtils.prefs!.setString('name', data['name'].toString());
                    PrefUtils.prefs!
                        .setString('FirstName', data['name'].toString());
                    PrefUtils.prefs!
                        .setString('FirstName', data['username'].toString());
                ...
                PrefUtils.prefs!.setString('FirstName', appleidentifier.givenName!);
                PrefUtils.prefs!.setString('LastName', appleidentifier.familyName!);
                PrefUtils.prefs!.setString("photoUrl", "");
                ...
                if (appleidentifier.mail.toString() == "null") {
                  ...
                  Navigation(context,
                      ...
                      navigatore: NavigatoreTyp.Push,
                      qparms: {"prev": "signupSelectionScreen"});
                } else {
      ...
      Fluttertoast.showToast(
          msg: S
              .of(context)
              .apple_signin_not_available_forthis_device, //"Apple SignIn is not available for your device!",
          fontSize: MediaQuery.of(context).textScaleFactor * 13,
          backgroundColor: Colors.black87,
          gravity: ToastGravity.BOTTOM,
          textColor: Colors.white);
    ...
    if (controller.text == PrefUtils.prefs!.getString('Otp')) {
      if (PrefUtils.prefs!.getString('type') == "old") {
        ...
        if (PrefUtils.prefs!.getString('prevscreen') == 'signingoogle' ||
            PrefUtils.prefs!.getString('prevscreen') ==
  ...
  _saveAddInfoForm() async {
    ...
    //checkemail();
    _dialogforProcessing();
    if (PrefUtils.prefs!.getString('Email') == "" ||
        PrefUtils.prefs!.getString('Email') == "null") {
      return SignupUser();
    } else {
      checkemail();
    }
  ...
  Future<void> signupUser() async {
    ...
    try {
      ...
      final response = await http.post(Api.register, body: {
        ...
        "signature": PrefUtils.prefs!.containsKey("signature")
            ? PrefUtils.prefs!.getString('signature')
            : "",
      ...
      if (responseJson['status'].toString() == "true") {
        ...
        PrefUtils.prefs!
            .setString('membership', responseJson['membership'].toString());
  ...
  Future<void> SignupUser() async {
    ...
    try {
      ...
      String name = PrefUtils.prefs!.getString('FirstName').toString() +
          " " +
          PrefUtils.prefs!.getString('LastName').toString();
      ...
      final response = await http.post(Api.register, body: {
        "username": name,
        "email": PrefUtils.prefs!.getString('Email'),
        "mobileNumber": PrefUtils.prefs!.containsKey("Mobilenum")
            ? PrefUtils.prefs!.getString('Mobilenum')
            : "",
        "path": apple,
        "tokenId": PrefUtils.prefs!.getString('tokenid'),
        "branch": PrefUtils.prefs!.getString('branch'),
      ...
      if (responseJson['status'].toString() == "true") {
        ...
        PrefUtils.prefs!
            .setString('membership', responseJson['membership'].toString());
        PrefUtils.prefs!
            .setString("mobile", PrefUtils.prefs!.getString('Mobilenum')!);
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  S
                                      .of(context)
                                      .tell_us_your_email, //'Tell us your e-mail',
                                  style: TextStyle(
                                      fontSize: 17, color: ColorCodes.lightBlack
                                    // Color(0xFF1D1D1D)
                                  ),
                                ...
                                Text(
                                  S
                                      .of(context)
                                      .we_will_email, //' We\'ll email you as a reservation confirmation.',
                                  style: TextStyle(
                                      fontSize: 15.2,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            S
                                .of(context)
                                .we_will_call_or_text, //"We'll call or text you to confirm your number. Standard message data rates apply.",
                            style: TextStyle(
                        ...
                        MouseRegion(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () {
                              PrefUtils.prefs!.setString('skip', "no");
                              PrefUtils.prefs!
                                  .setString('prevscreen', "mobilenumber");
                              // PrefUtils.prefs!.setString('Mobilenum', value);
                              _saveFormLogin();
                              _dialogforProcess();
                            },
                            ...
                            text: new TextSpan(
                              ...
                              children: <TextSpan>[
                                new TextSpan(
                                  text: S
                                      .of(context)
                                      .agreed_terms, //'By continuing you agree to the '
                                ),
                                new TextSpan(
                                    text: S
                                        .of(context)
                                    ...
                                    recognizer: new TapGestureRecognizer()
                                      ..onTap = () {
                                        Navigation(context,
                                            ...
                                            parms: {
                                              "title":
                                              "Terms of Use" /*, "body" :IConstants.restaurantTerms*/
                                            });
                                      }),
                                new TextSpan(
                                    ...
                                    recognizer: new TapGestureRecognizer()
                                      ..onTap = () {
                                        Navigation(context,
                                            ...
                                            parms: {
                                              "title":
                                              "Privacy" /*, "body" :PrefUtils.prefs!.getString("privacy").toString()*/
                                            });
                                      }),
                              ],
                            ),
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              S
                                                  .of(context)
                                                  .sign_in_with_google, //"Sign in with Google" , //"Sign in with Google",
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.bold,
                                                  color:
                                                  ColorCodes.signincolor),
                                            )
                                          ],
                                        ),
                                      ),
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              S
                                                  .of(context)
                                                  .sign_in_with_facebook, //"Sign in with Facebook" ,// "Sign in with Facebook",
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.bold,
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Text(
                                                S
                                                    .of(context)
                                                    .signin_apple, //"Sign in with Apple"  , //"Sign in with Apple",
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    fontSize: 16,
                                                    fontWeight: FontWeight.bold,
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                S
                                    .of(context)
                                    .please_check_otp_sent_to_your_mobile_number, //'Please check OTP sent to your mobile number',
                                style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    _notifyMe() async {
      ...
      //_notifyMe();
      int resposne = await Provider.of<BrandItemsList>(context, listen: false)
          .notifyMe(widget.itemdata!.id!, varid!, widget.itemdata!.type!);
      if (resposne == 200) {
        //_isWeb?_Toast("You will be notified via SMS/Push notification, when the product is available"):
        Fluttertoast.showToast(
            msg: S
                .of(context)
                .you_will_notify, //"You will be notified via SMS/Push notification, when the product is available" ,
            fontSize: MediaQuery.of(context).textScaleFactor * 13,
            backgroundColor: Colors.black87,
            textColor: Colors.white);
        setState(() {
...
*/ /*
    ...
    setState(() {
      if (varstock != null) if (int.parse(varstock!) <= 0) {
        _isStock = false;
      } else {
        _isStock = true;
      }
    ...
    */
    showoptions1() {
      ...
      (Vx.isWeb && !ResponsiveLayout.isSmallScreen(context))
            ...
            return StatefulBuilder(builder: (context, setState) {
              return Dialog(
                ...
                child: Container(
                  ...
                  //height: 200,
                  padding: EdgeInsets.fromLTRB(30, 20, 20, 20),
                  child: (widget.fromScreen == "search_item_multivendor" &&
                      Features.ismultivendor)
                      ? ItemVariation(
                    searchdata: widget.storedsearchdata!,
          ...
          context: context,
          builder: (context) {
            return (widget.fromScreen == "search_item_multivendor" &&
                Features.ismultivendor)
                ? ItemVariation(
                searchdata: widget.storedsearchdata!,
                ismember: _checkmembership,
    ...
    if (Vx.isWeb && !ResponsiveLayout.isSmallScreen(context)) {
      ...
      return widget.fromScreen == "search_item_multivendor" &&
        ...
        margin: EdgeInsets.only(
            left: 5.0, top: 5.0, bottom: 5.0, right: 5),
        child: Column(
          children: [
            ItemBadge(
              outOfStock: widget.storedsearchdata!.stock! <= 0
                  ? OutOfStock(
                singleproduct: false,
              )
                  : null,
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget
                            .storedsearchdata!.itemFeaturedImage,
                              ...
                              Container(
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      widget.storedsearchdata!.ratings!
                                          .toStringAsFixed(2),
                                      style: TextStyle(
                                          fontSize: 11,
                                          color:
                                    ...
                                    Text(
                                      widget.storedsearchdata!.distance!
                                          .toStringAsFixed(2) +
                                          " Km",
                                      style: TextStyle(
                                          fontSize: 11,
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                              new TextSpan(
                                                  text: Features
                                                      ...
                                                      ? '${_checkmembership ? widget.storedsearchdata!.membershipPrice : widget.storedsearchdata!.price} ' +
                                                      IConstants
                                                          .currencyFormat
                                                      : IConstants
                                                      .currencyFormat +
                              ...
                              if (Features.netWeight &&
                                  widget.storedsearchdata!.vegType ==
                                      "fish")
                                Container(
                                  width:
                                  (MediaQuery.of(context).size.width /
                          ...
                          if (ResponsiveLayout.isSmallScreen(context))
                            if (Features.isSubscription)
                              (widget.storedsearchdata!
                                  ...
                                  0)
                                  ? Container(
                                width: (widget.fromScreen == "brands_screen" ||
                                    widget.fromScreen ==
                                        "sellingitem_screen" ||
                                    widget.fromScreen ==
                                      ...
                                      Navigation(
                                          ...
                                          qparms: {
                                            ...
                                            "varmrp": widget
                                                .storedsearchdata!
                                                .mrp,
                                            "varprice": store.userData.membership! ==
                                                "1"
                                                ? widget
                                                .storedsearchdata!
                                                .membershipPrice
                                                .toString()
                                                : widget.storedsearchdata!.discointDisplay!
                                                ? widget.storedsearchdata!.price.toString()
                                                : widget.storedsearchdata!.mrp.toString(),
                                            "paymentMode": widget
                                                .storedsearchdata!
                                                .paymentMode,
                                            "cronTime": widget
                                            ...
                                            "brand": widget
                                                .storedsearchdata!
                                                .brand,
                                            "deliveriesarray": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .deliveries,
                                            "daily": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .daily,
                                            "dailyDays": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .dailyDays,
                                            "weekend": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .weekend,
                                            "weekendDays": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .weekendDays,
                                            "weekday": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .weekday,
                                            "weekdayDays": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .weekdayDays,
                                            "custom": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
                                            ...
                                            0]
                                                ...
                                                .subscriptionSlot![0]
                                                .custom,
                                            "customDays": (widget.fromScreen == "search_item_multivendor" &&
                                                Features
                                                    .ismultivendor)
                                                ? widget
                                                .storedsearchdata!
...
//                           ),
                                ...
                                child: SizedBox(
                                    child: CustomeStepper(
                                      ...
                                      height: (Features.isSubscription)
                                          ? 90
                                          : 60,
                                      addon: (widget.storedsearchdata!
                                          .addon!.length >
                                          0)
                                          ? widget
                                          .storedsearchdata!.addon![0]
                                          : null,
                                      index: itemindex,
                                      ismember: _checkmembership,
                                      selectedindex: itemindex,
                ...
                if (ResponsiveLayout.isSmallScreen(context))
                  if (Features.isMembership)
                    (widget.fromScreen == "brands_screen" ||
                        widget.fromScreen ==
                            "sellingitem_screen" ||
                        widget.fromScreen ==
                            "shoppinglistitem_screen" ||
                        widget.fromScreen == "home_screen" ||
                        widget.fromScreen ==
                            "searchitem_screen" ||
                        widget.fromScreen == "not_product_screen")
                        ? Container(
                      width:
                      (MediaQuery.of(context).size.width /
                          4) +
        ...
        child: Column(
          children: [
            ItemBadge(
              outOfStock: widget.storedsearchdata!
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                              new TextSpan(
                                                  text: Features
                                                      .iscurrencyformatalign
                                                      ? '${_checkmembership ? widget.storedsearchdata!.priceVariation![itemindex].membershipPrice : widget.storedsearchdata!.priceVariation![itemindex].price} ' +
                                                      IConstants
                                                          .currencyFormat
                                                      : IConstants
                                                      .currencyFormat +
                                              ...
                                              new TextSpan(
                                                  ...
                                                  itemindex]
                                                      ...
                                                      ? Features
                                                      .iscurrencyformatalign
                                                      ? '${widget.storedsearchdata!.priceVariation![itemindex].mrp} ' +
                                                      IConstants
                                                          .currencyFormat
                                                      : IConstants
                                                      .currencyFormat +
...
//                SizedBox(height: 10,),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      //"$varname"+" "+"$unit",
                                      "${widget.storedsearchdata!.priceVariation![itemindex].variationName}" +
                                          " " +
                                          "${widget.storedsearchdata!.priceVariation![itemindex].unit}",
                                      style: TextStyle(
                                          color: ColorCodes
                                              .darkgreen,
                                          fontWeight:
                                      ...
                                      Navigation(
                                          ...
                                          qparms: {
                                            ...
                                            "varprice": store.userData.membership! ==
                                                ...
                                                .membershipPrice
                                                .toString()
                                                : widget.storedsearchdata!.priceVariation![itemindex].discointDisplay!
                                                ? widget.storedsearchdata!.priceVariation![itemindex].price.toString()
                                                : widget.storedsearchdata!.priceVariation![itemindex].mrp.toString(),
                                            "paymentMode": widget
                                                .storedsearchdata!
                                                .paymentMode,
                                            "cronTime": widget
        ...
        child: Column(
          children: [
            ItemBadge(
              outOfStock: widget.itemdata!.stock! <= 0
                  ? OutOfStock(
                singleproduct: false,
              )
                  : null,
                    ...
                    onTap: () {
                      if (widget.fromScreen == "sellingitem_screen") {
                        ...
                        Navigation(context,
                            ...
                            navigatore: NavigatoreTyp.Push,
                            parms: {
                              "varid": widget.itemdata!.id.toString(),
...
// Navigator.of(context).pop();
        ...
        child: Column(
          children: [
            ItemBadge(
              outOfStock: widget.itemdata!.priceVariation![itemindex]
                  .stock! <=
                  0
                  ? OutOfStock(
                singleproduct: false,
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget
                            ...
                            .length <=
                            0
                            ? widget.itemdata!.itemFeaturedImage
                            : widget
                            .itemdata!
                            .priceVariation![itemindex]
                            .images![0]
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                              new TextSpan(
                                                  text: Features
                                                      .iscurrencyformatalign
                                                      ? '${_checkmembership ? widget.itemdata!.priceVariation![itemindex].membershipPrice : widget.itemdata!.priceVariation![itemindex].price} ' +
                                                      IConstants
                                                          .currencyFormat
                                                      : IConstants
                                                      .currencyFormat +
                                              ...
                                              new TextSpan(
                                                  ...
                                                  itemindex]
                                                      ...
                                                      ? Features
                                                      .iscurrencyformatalign
                                                      ? '${_checkmembership ? widget.itemdata!.priceVariation![itemindex].membershipDisplay! ? widget.itemdata!.priceVariation![itemindex].mrp : "" : ""}' +
                                                      IConstants
                                                          .currencyFormat
                                                      : '${_checkmembership ? widget.itemdata!.priceVariation![itemindex].membershipDisplay! ? IConstants.currencyFormat + widget.itemdata!.priceVariation![itemindex].mrp! : "" : ""}'
                                                      : "",
                                                  style: TextStyle(
                                                      decoration:
                                                      TextDecoration
                                                ...
                                                MembershipScreen.routeName,
                                                          ...
                                                          Container(
                                                            ...
                                                            BoxDecoration(
                                                              ...
                                                              Border(
                                                                right:
                                                                BorderSide(width: 5.0, color: ColorCodes.darkgreen),
                                                              ...
                                                              children: <
                                                                ...
                                                                Text(
                                                                  // S .of(context).membership_price+ " " +//"Membership Price "
                                                                    Features.iscurrencyformatalign ? widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() + IConstants.currencyFormat : IConstants.currencyFormat + widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() /*+ " " +S.of(context).membership_price*/ + " Membership Price",
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                bottom: 10, left: 10, right: 10),
                            child: (widget.itemdata!.priceVariation!
                                .length >
                                1)
                                ? GestureDetector(
                              onTap: () {
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      //"$varname"+" "+"$unit",
                                      "${widget.itemdata!.priceVariation![itemindex].variationName}" +
                                          " " +
                                          "${widget.itemdata!.priceVariation![itemindex].unit}",
                                      style: TextStyle(
                                          color: ColorCodes
                                              .darkgreen,
                                          fontWeight:
                                      ...
                                      Navigation(
                                          ...
                                          qparms: {
                                            ...
                                            "varprice": store.userData.membership! ==
                                                ...
                                                .membershipPrice
                                                .toString()
                                                : widget.itemdata!.priceVariation![itemindex].discointDisplay!
                                                ? widget.itemdata!.priceVariation![itemindex].price.toString()
                                                : widget.itemdata!.priceVariation![itemindex].mrp.toString(),
                                            "paymentMode": widget
                                                .itemdata!
                                                .paymentMode,
                                            "cronTime": widget
                            ...
                            children: [
                              Expanded(
                                child: SizedBox(
                                  ...
                                  // (MediaQuery.of(context).size.width / 5.5),
                                    child: CustomeStepper(
                                      priceVariation: widget.itemdata!
                                          .priceVariation![itemindex],
                                      itemdata: widget.itemdata,
                                      from: "selling_item",
                                      checkmembership: _checkmembership,
...
// Navigator.of(context).pop();
                ...
                !_checkmembership
                    ? widget.itemdata!.priceVariation![itemindex]
                    .membershipDisplay!
                    ? SizedBox(
                  height: 12,
                )
      ...
      return widget.fromScreen == "search_item_multivendor" &&
          ...
          if (widget.fromScreen == "sellingitem_screen") {
            if (widget.storedsearchdata!.stock! >= 0)
              ...
              Navigation(context,
                  ...
                  navigatore: NavigatoreTyp.Push,
                  parms: {
                    "varid": widget.storedsearchdata!
                        .priceVariation![itemindex].menuItemId
                        .toString(),
                    "productId": widget.storedsearchdata!
                        .priceVariation![itemindex].menuItemId
                        .toString()
                  });
            // else
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              bottom: BorderSide(
                  width: 2.0, color: ColorCodes.lightGreyWebColor),
            ),
          ),
          margin: (Features.ismultivendor)
              ? EdgeInsets.only(left: 0.0, bottom: 0.0, right: 0)
              : EdgeInsets.only(left: 5.0, bottom: 0.0, right: 5),
          child: Row(
            children: [
              Container(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              margin: EdgeInsets.only(
                                  top: 4.0, bottom: 3.0),
                              child: CachedNetworkImage(
                                imageUrl: widget.storedsearchdata!
                                    .itemFeaturedImage,
                                errorWidget: (context, url, error) =>
                                    Image.asset(
                                      Images.defaultProductImg,
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                              ...
                                              new TextSpan(
                                                  text: _mrp,/*widget.storedsearchdata!
                                                                    .price !=
                                                                widget
                                                                    .storedsearchdata!
                                                                    .mrp
...
//                        mainAxisAlignment: MainAxisAlignment.center,
                                                  ...
                                                  children: <Widget>[
                                                    SizedBox(width: 2),
                                                    Text(Features.iscurrencyformatalign ? widget.storedsearchdata!.membershipPrice.toString() + IConstants.currencyFormat : IConstants.currencyFormat + widget.storedsearchdata!.membershipPrice.toString() + " Membership Price",
                                                        style: TextStyle(
                                                            fontWeight: FontWeight.bold,
...
// Navigator.of(context).pop();
                  ...
                  if (Features.netWeight &&
                      widget.storedsearchdata!.vegType == "fish")
                    Container(
                      width: (MediaQuery.of(context).size.width / 2) +
                          70,
                      child: Column(
        ...
        onTap: () {
          if (widget.fromScreen == "sellingitem_screen") {
            if (widget.storedsearchdata!.priceVariation![itemindex]
                .stock! >=
                0)
              /*navigatetoSingelproductscreen(context,widget.returnparm,
                  duration: widget.itemdata.duration,
                                                          ...
                                                          children: [
                                                            ...
                                                            _groupValue == i
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Icon(Icons.check, color: ColorCodes.whiteColor, size: 12.0),
                                                              ),
                                                            )
...
//                        mainAxisAlignment: MainAxisAlignment.center,
                                                    ...
                                                    children: <
                                                      ...
                                                      SizedBox(
                                                          width: 2),
                                                      Text(
                                                          Features.iscurrencyformatalign ? widget.storedsearchdata!.priceVariation![itemindex].membershipPrice.toString() + IConstants.currencyFormat : IConstants.currencyFormat + widget.storedsearchdata!.priceVariation![itemindex].membershipPrice.toString() + " Membership Price",
                                                          style: TextStyle(
                                                              fontSize: ResponsiveLayout.isSmallScreen(context)
                                                                  ? 10
                                                                  : ResponsiveLayout.isMediumScreen(context)
                                    ...
                                    MembershipScreen.routeName,
                                            ...
                                            Container(
                                              ...
                                              BoxDecoration(
                                                ...
                                                Border(
                                                  left:
                                                  BorderSide(width: 3.0, color: ColorCodes.darkgreen),
                                                  right:
                                                  BorderSide(width: 0.5, color: Colors.lightGreen),
                                                  bottom:
                                                  BorderSide(width: 0.5, color: Colors.lightGreen),
                                                  top:
                                                  BorderSide(width: 0.5, color: Colors.lightGreen),
...
//                        mainAxisAlignment: MainAxisAlignment.center,
                                                ...
                                                children: <
                                                  ...
                                                  Text(
                                                    ...
                                                    //widget.itemdata!.membershipPrice.toString() + IConstants.currencyFormat
                                                      IConstants.currencyFormat + widget.itemdata!.membershipPrice.toString() + " Membership Price",
                                                      style: TextStyle(
                                                          fontWeight: FontWeight.bold,
                                                          fontSize: ResponsiveLayout.isSmallScreen(context)
                                                              ? 6
...
//                               _checkmembership?(int.parse(widget.itemdata!.mrp!) - int.parse(widget.itemdata!.membershipPrice!))>0?
//                               Container(
...
//                                   border: Border(
//                                       left: BorderSide(width: 5.0, color: ColorCodes.darkgreen),
//                                       bottom: BorderSide(width: 0.5, color: ColorCodes.lightgreen),
//                                       top:BorderSide(width: 0.5, color: ColorCodes.lightgreen),
//                                       right: BorderSide(width:0.5, color: ColorCodes.lightgreen)
//                                   ),
//                                   color: ColorCodes.varcolor,
//                                 ),
//                                 child: Row(
...
//                                     IConstants.currencyFormat +(int.parse(widget.itemdata!.price!) - int.parse(widget.itemdata!.membershipPrice!)).toString()+ " Membership Savings"
//                                         : IConstants.currencyFormat +(int.parse(widget.itemdata!.mrp!) - int.parse(widget.itemdata!.membershipPrice!)).toString()+ " Membership Savings",
//                                         style: TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 8 : ResponsiveLayout.isMediumScreen(context) ? 10 : 12,color: ColorCodes.greenColor,fontWeight: FontWeight.bold)),
//
//
//                                   ],
//                                 ),
...
// Navigator.of(context).pop();
                              ...
                              if (Features.isLoyalty)
                                (double.parse(widget.itemdata!.loyalty
                                    .toString()) >
                                    0)
                                    ? Container(
                                  child: Row(
                              ...
                              // SizedBox(height: 5,),
                              (widget.itemdata!.addon!.length > 0)
                                  ? Row(
                                children: [
                                  Text('Customize',
                                      style: TextStyle(
                                ...
                                builder:
                                  ...
                                  if (store.userData.membership! ==
                                    ...
                                    i++) {
                                      ...
                                      //print("membership......"+_checkmembership.toString());
                                    }
                                  }
                                  return Column(
                                    children: [
                                      ...
                                      SignupSelectionScreen.routeName)*/
                                                Navigation(context,
                                                    name: Routename.SignUpScreen,
                                                    navigatore: NavigatoreTyp.PushReplacment)
                                                    : /*Navigator.of(context).pushNamed(
                                    MembershipScreen.routeName,
                                  );*/
                                                Navigation(context, name: Routename.Membership, navigatore: NavigatoreTyp.Push);
...
//                        mainAxisAlignment: MainAxisAlignment.center,
                                                  ...
                                                  children: <
                                                    ...
                                                    Text(
                                                        Features.iscurrencyformatalign
                                                            ? widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() + IConstants.currencyFormat
                                                            : IConstants.currencyFormat + widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() + " Membership Price",
                                                        style: TextStyle(
                                                            fontSize: ResponsiveLayout.isSmallScreen(context)
                                                                ? 10
                                                                : ResponsiveLayout.isMediumScreen(context)
...
//                               _checkmembership?(int.parse(widget.itemdata!.priceVariation![itemindex].mrp!) - int.parse(widget.itemdata!.priceVariation![itemindex].membershipPrice!))>0?
//                               Container(
//                                 padding: EdgeInsets.symmetric(vertical: 5,),
//                                 width: (MediaQuery
//                                     .of(context)
...
//                                     IConstants.currencyFormat +(int.parse(widget.itemdata!.priceVariation![itemindex].price!) - int.parse(widget.itemdata!.priceVariation![itemindex].membershipPrice!)).toString()+ " Membership Savings"
//                                         : IConstants.currencyFormat +(int.parse(widget.itemdata!.priceVariation![itemindex].mrp!) - int.parse(widget.itemdata!.priceVariation![itemindex].membershipPrice!)).toString()+ " Membership Savings",
//                                         style: TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 8 : ResponsiveLayout.isMediumScreen(context) ? 10 : 12,color: ColorCodes.greenColor,fontWeight: FontWeight.bold)),
//
//
//                                   ],
...
//                                     return Column(
//                                       children: [
//                                         if(Features.isMembership && double.parse(widget.itemdata!.priceVariation![itemindex].membershipPrice.toString()) > 0)
//                                           Row(
//                                             children: <Widget>[
//                                               !_checkmembership
//                                                   ? widget.itemdata!.priceVariation![itemindex].membershipDisplay!
...
//                                                           widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() + IConstants.currencyFormat:
//                                                           IConstants.currencyFormat +
//                                                               widget.itemdata!.priceVariation![itemindex].membershipPrice.toString() /*+ " " +S.of(context).membership_price*/+" Membership Price",
//                                                           style: TextStyle(fontSize: 9.0,/*fontWeight: FontWeight.bold,*/color: ColorCodes.darkgreen,fontWeight: FontWeight.bold)),
//
//                                                       SizedBox(width: 5),
//                                                     ],
...
Future<bool> navigatetoSingelproductscreen(context, returnparm,
    {fromScreen,
      seeallpress,
      id,
      title,
