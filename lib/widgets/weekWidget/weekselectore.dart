            ...
            if(widget.custom == "1")
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                      top: BorderSide(  color: ColorCodes.mediumgren,width: _customWidth),
                      bottom: BorderSide(  color: ColorCodes.mediumgren,width: _customWidth),
                      left: BorderSide(  color: ColorCodes.mediumgren,width: _customWidth),
                      right: BorderSide(  color: ColorCodes.mediumgren,width: _customWidth),
              ...
              debugPrint("i........"+data[i].toString());
                         return    GestureDetector(
                           ...
                           child: Container(
                             ...
                             height: 30,
                             decoration: BoxDecoration(
                               color: data[i]['isSelected'] == true?ColorCodes.mediumgren:Colors.transparent,
                               border: Border.all(color:data[i]['isSelected'] == true? ColorCodes.mediumgren: ColorCodes.mediumgren),
                               borderRadius: BorderRadius.all(Radius.circular(3)),
                             ),  child: Center(
                                      child: Text(
                                        data[i]['name'],
