      ...
      child: GestureDetector(
        onTap: () async{
          ...
          if (widget.allbanners.bannerFor == "1") {
            ...
            PrefUtils.prefs!.containsKey("apikey") ?
             (Vx.isWeb && !ResponsiveLayout.isSmallScreen(
                context)) ?
        ...
        child: Container(
          ...
          ClipRRect(
            ...
            child: CachedNetworkImage(
              imageUrl: widget.allbanners.bannerImage, fit: BoxFit.fitWidth,
          ...
          ClipRRect(
            ...
            child: CachedNetworkImage(
              ...
              errorWidget: (context, url, error) => Image.asset(Images.defaultSliderImg, fit: BoxFit.fitWidth,),
            ),
          )
