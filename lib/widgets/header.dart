...
class _HeaderState extends State<Header> with Navigations {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      setState(() {
        ...
        if (!Features.ismultivendor) if ((!PrefUtils.prefs!
                    .containsKey("welcomeSheet") &&
                !PrefUtils.prefs!.containsKey('apikey')) &&
            !Vx.isWeb) welcomeSheet();
      });
    });
  ...
  search(String value) async {
    ...
    await Provider.of<ItemsList>(context, listen: false)
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(S.of(context).product_and_location_specified,
                      style: TextStyle(
                          color: ColorCodes.greyColor,
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0)
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: FlatButton(
                          ...
                          padding: EdgeInsets.only(
                              left: 3, top: 0, right: 0.0, bottom: 0),
                          textColor: ColorCodes.darkgreen,
                          child: Text(
                              S.of(context).explore +
                                  " " +
                                  (PrefUtils.prefs!
                                          .getString("restaurant_location") ??
                                      ""),
                      ...
                      Center(
                          child: Text(S.of(context).or,
                              style: TextStyle(
                                  fontSize: 13.0, color: ColorCodes.darkGrey))),
                      Container(
                        child: FlatButton(
                          height: 0,
                          minWidth: 0,
                          padding: EdgeInsets.only(
                              left: 3.0, top: 0, right: 0.0, bottom: 0),
                          textColor: ColorCodes.darkgreen,
                          child: Text(S.of(context).change_location,
                              style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FlatButton(
                        ...
                        child: Text(S.of(context).login_small,
                            style: TextStyle(
                        ...
                        children: [
                          if (store.language.languages.length > 1)
                            Text(
                                S
                                    .of(context)
                                    .chose_your_preferred_language, //'Choose your preferred language' ,
                                style: TextStyle(
                                    color: ColorCodes.greyColor,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14)),
                                ...
                                FlatButton(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          store
                                              .language.languages[i].localName!,
                                          style: TextStyle(
                                              color: Theme.of(context)
                                                  .primaryColor,
                                              fontSize: 16,
                                              fontWeight: store.language
                                                          .languages[i].code ==
                                      ...
                                      store.language.languages[i].code ==
  ...
  Widget searchList() {
    final popularSearch =
        (VxState.store as GroceStore).homescreen.data!.featuredByCart;
                            ...
                            itemBuilder: (_, i) => Column(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    final variationdate =
                                        searchData.findByIdsearch(
                                            searchDispaly[i].id.toString());
                                    ...
                                    Navigation(context,
                                        ...
                                        navigatore: NavigatoreTyp.Push,
                                        parms: {
                                          "varid": variationdate.first.varid!,
                                          "productId":
                                              variationdate.first.menuid!
                                        });
                                  },
                                  child: Container(
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  Navigation(context,
                                      ...
                                      parms: {
                                        "varid": popularSearch
                                            .data![i].priceVariation!.first.id!,
                                        "productId": popularSearch.data![i]
                                            .priceVariation!.first.menuItemId!
                                      });
                                },
                                child: Container(
      ...
      builder: (context,  store, state) {
        ...
        if (store.homescreen.data != null) {
          if (store.homescreen.data!.allBrands!.length > 0 ||
              ...
              (store.homescreen.data!.discountByCart != null) &&
                ...
                children: [
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        if (!widget._isHome) {
                          HomeScreenController(
                              ...
                              branch: (VxState.store as GroceStore)
                                      .userData
                                      .branch ??
                                  "999",
                              rows: "0");
                      ...
                      child: Features.isWebTrail
                          ? Features.logo != ""
                              ? CachedNetworkImage(
                                  width: 200, imageUrl: "${Features.logo}")
                              : SizedBox(
                                  width: 200,
                                )
                          : Image.asset(
                  ...
                  Container(
                    ...
                    child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding:
                              EdgeInsets.only(top: 13, left: 20, right: 10),
                          hintText: S
                              .of(context)
                          ...
                          onTap: () {
                            ...
                            LoginWeb(context, result: (sucsess) {
                              if (sucsess) {
                                Navigator.of(context).pop();
                                HomeScreenController(
                                    user: (VxState.store as GroceStore)
                                            .userData
                                            .id ??
                                        PrefUtils.prefs!.getString("ftokenid"),
                                    branch: (VxState.store as GroceStore)
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (BuildContext bc) => [
                              ...
                              PopupMenuItem(
                                  child: Row(
                                    children: [
                                      Image.asset(Images.appbar_myorder,
                                          height: 30.0,
                                          width: 30.0,
                                          color: ColorCodes.blackColor),
                                      SizedBox(
                              ...
                              PopupMenuItem(
                                  child: Row(
                                    children: [
                                      Image.asset(Images.appbar_address,
                                          height: 20.0,
                                          width: 20.0,
                                          color: ColorCodes.blackColor),
                                      SizedBox(
                              ...
                              if (Features.isLoyalty)
                                PopupMenuItem(
                                    child: Row(
                                      children: [
                                        Image.asset(Images.app_loyaltyweb,
                                            height: 20.0,
                                            width: 20.0,
                                            color: ColorCodes.blackColor),
                                        SizedBox(
                              ...
                              if (store.language.languages.length > 1)
                                PopupMenuItem(
                                    child: Row(
                                      children: [
                                        Image.asset(Images.addLanguage,
                                            height: 25.0,
                                            width: 25.0,
                                            color: ColorCodes.blackColor),
                                        SizedBox(
                  ...
                  builder: (context, setState) {
                    return ControlledScrollView(
                      ...
                      onLeftClick: () {
                        ...
                        cstscrollcontroller.animateTo(
                            cstscrollcontroller.offset - 200,
                            curve: Curves.easeIn,
                      ...
                      onRightClick: () {
                        ...
                        if ((cstscrollcontroller.position.maxScrollExtent
                                    .toInt() -
                                100) <
                            finalcso) {
                          setState(() {
                      ...
                      child: new ListView.builder(
                        ...
                        itemBuilder: (_, j) => showSubCategory(
                            store.homescreen.data!.allCategoryDetails![j].id!,
                            store.homescreen.data!.allCategoryDetails![j]
                                .categoryName!,
                            store.homescreen.data!.allCategoryDetails![j]
                                .description!),
                      ),
  ...
  createHeaderForMobile() {
    ...
    debugPrint("isPushNotification" +
        Features.isPushNotification.toString() +
        " " +
        Features.isPushNotificationroot.toString() +
        " " +
        Features.ismultivendor.toString());
    return Container(
        decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(
        ...
        child: Column(children: <Widget>[
                  ...
                  ? Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          if (!Features.isWebTrail) SizedBox(width: 10),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Text(
                                  S
                                      .of(context)
                                      .download_app_for_best, //"Download the app for the best",
                                  style: TextStyle(
                                      fontSize: 12,
                                      color: IConstants.isEnterprise &&
                                              !Features.isWebTrail
                              ...
                              Text(
                                  S
                                      .of(context)
                                      .grocery_experience, //"Grocery Shopping Experiance",
                                  style: TextStyle(
                                      fontSize: 12,
                                      color: IConstants.isEnterprise &&
                                              !Features.isWebTrail
                                  ...
                                  if (Vx.isWeb) {
                                    launch(
                                        'https://play.google.com/store/apps/details?id=' +
                                            IConstants.androidId);
                                  } else if (!Vx.isWeb) {
                                    launch('https://apps.apple.com/us/app/id' +
                                        IConstants.appleId);
                                  }
                                },
                                child: Container(
            ...
            children: [
              Row(
                children: <Widget>[
                  ValueListenableBuilder(
                      ...
                      builder: (context, value, widget) {
                        return IconButton(
                          ...
                          icon: Image.asset(Images.drawerImage,
                              color: IConstants.isEnterprise &&
                                      !Features.ismultivendor &&
                                      !Features.ismultivendor
                                  ? IConstants.isEnterprise &&
                                      ...
                                      : ColorCodes.primaryColor
                                  : ColorCodes.blackColor,
                              width: IConstants.isEnterprise &&
                                      !Features.isWebTrail
                                  ? 20.0
                                  : 30,
                              height: IConstants.isEnterprise &&
                                      !Features.isWebTrail
                                  ? 25.0
                                  : 30
                          ...
                          onPressed: () {
                            if (value != S.of(context).not_available_location)
                              Features.ismultivendor
                                  ? StoreScreen.scaffoldKey.currentState!
                                      .openDrawer()
                  ...
                  //     ? Features.logo != ""
                  //         ? CachedNetworkImage(
                  //             imageUrl: "${Features.logo}", height: 75, width: 165)
                  //         : SizedBox(
                  //             width: 200,
                  //           )
                  //     : Image.asset(
                  ...
                  //               ),
                  //             )
                  //           : (Features.isWhatsapp && !Features.ismultivendor)
                  //               ? GestureDetector(
                  //                   onTap: () {
                  //                     launchWhatsApp();
                  //                   },
                  ...
                  ValueListenableBuilder(
                      valueListenable: IConstants.currentdeliverylocation,
                      builder: (context, value, widget) {
                        return (Features.ismultivendor &&
                                Features.isPushNotificationroot)
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          if (value !=
                                              S
                                                  .of(context)
                                                  .not_available_location) if (!PrefUtils
                                              .prefs!
                                              .containsKey("apikey")) {
                                            Navigation(context,
                                                name: Routename.SignUpScreen,
                                        ...
                                        child: Image.asset(
                                          ...
                                          color: IConstants.isEnterprise &&
                                              ...
                                              ? IConstants.isEnterprise &&
                                                  ...
                                                  : ColorCodes
                                                      .mediumBlackWebColor
                                              : ColorCodes.mediumBlackWebColor,
                                        ),
                                      ),
                                    );
                            ...
                            : (Features.isPushNotification &&
                                    !Features.ismultivendor)
                                ? ValueListenableBuilder(
                                    valueListenable:
                                        IConstants.currentdeliverylocation,
                                    builder: (context, value, widget) {
              ...
              Positioned(
                left: (MediaQuery.of(context).size.width - 138) / 2,
                child: Features.isWebTrail
                    ? Features.logo != ""
                        ? CachedNetworkImage(
                            imageUrl: "${Features.logo}",
                                ...
                                children: [
                                  ...
                                  VxBuilder(
                                      ...
                                      builder:
                                        ...
                                        _deliverLocation =
                                            store.userData.area != null
                                                ? store.userData.area!
                                                : "";
                                        print("delivery location...." +
                                            _deliverLocation.toString());
                                        if (_deliverLocation != null) {
                                          if (_deliverLocation.indexOf(' ') >=
                                              0) {
                                            int idx =
                                                _deliverLocation.indexOf(" ");
                                            _deliveryLocmain = _deliverLocation
                                                .substring(0, idx)
                                                .trim()
                                                .toString();
                                            _deliverySubloc = _deliverLocation
                                                .substring(idx + 1)
                                                .trim()
                                                .toString();
                                          }
                                          if (_deliverLocation.indexOf(',') >=
                                            ...
                                            _deliveryLocmain =
                                                _deliverLocation; //_deliverLocation.substring(0,idx).trim().toString();
                                            _deliverySubloc =
                                                _deliverLocation; //_deliverLocation.substring(idx+1).trim().toString();
                                          }
                                        }
                                        return Padding(
                                          padding:
                                              ...
                                              child: RichText(
                                                ...
                                                text: new TextSpan(
                                                  children: <TextSpan>[
                                                    ...
                                                    new TextSpan(
                                                      text:
                                                          _deliverySubloc, //_delLocation[1].trim(),//"Ambalapadi, Udupi, Karnataka...............",
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          fontSize: 9,
                                          ...
                                          child: Container(
                                            child: Row(
                                              children: [
                                                ...
                                                Text(
                                                  S.current
                                                      .search_from_products, //" Search From 10,000+ products",
                                                  style: TextStyle(
                                                    color:
                                                        ColorCodes.primaryColor,
                                                    fontSize: 12.0,
                        ...
                        children: [
                          ...
                          VxBuilder(
                              ...
                              builder: (context, store, state) {
                                ...
                                String _deliveryLocmain = "";
                                String _deliverySubloc = "";
                                _deliverLocation = store.userData.area != null
                                    ? store.userData.area!
                                    : "";
                                print("delivery location...." +
                                    _deliverLocation.toString());
                  ...
                  child: Row(
                    children: [
                      ...
                      VxBuilder(
                          ...
                          builder: (context, store, state) {
                            debugPrint(
                                "aa....///." + store.userData.area.toString());
                            String _deliverLocation = "";
                            String _deliveryLocmain = "";
                            String _deliverySubloc = "";
                            _deliverLocation = store.userData.area != null
                                ? store.userData.area!
                                : Features.ismultivendor
                                    ? PrefUtils.prefs!.containsKey("area")
                                        ? PrefUtils.prefs!.getString("area") ??
                                            ""
                                        : ""
                                    : "";
                            print("delivery location...." +
                                      ...
                                      child: Container(
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              Features.ismultivendor
                                                  ? S.current.search_store_prouct /*"Search stores and products"*/ : S
                                                      .current
                                                      .search_from_products, //" Search From 10,000+ products",
                                              style: TextStyle(
                                                color: Features.ismultivendor
          ...
          Container(
            height: 4,
            width: MediaQuery.of(context).size.width,
            color: IConstants.isEnterprise && !Features.ismultivendor
                ? IConstants.isEnterprise && !Features.isWebTrail
                    ? ColorCodes.headerColor
                    : ColorCodes.whiteColor
                : ColorCodes.whiteColor,
  ...
  showSubCategory(String catid, String title, String description) {
    ...
    if (store
        .homescreen
        .data!
        .allCategoryDetails![store.homescreen.data!.allCategoryDetails!
            .indexWhere((element) => element.id == catid)]
        .subCategory
        .isEmpty)
    ...
    return VxBuilder(
        builder: (context, store, state) {
          ...
          if (catlist != null)
            subcategoryData = store
                .homescreen
                .data!
                .allCategoryDetails![
                    catlist.indexWhere((element) => element.id == catid)]
                .subCategory;
          return Container(
            padding: EdgeInsets.only(
              left: 20, /*bottom:30*/
              ...
              itemBuilder: (_) => <PopupMenuItem<String>>[
                for (j = 1; j < subcategoryData.length; j++)
                  new PopupMenuItem<String>(
                    height: 30,
                    child: Text(
                      subcategoryData[j].categoryName!,
