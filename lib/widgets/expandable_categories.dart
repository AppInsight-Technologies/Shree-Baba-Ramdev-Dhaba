    ...
    return (IConstants.isEnterprise)
      ...
      builder: (context, snapshot) {
        ...
        (widget.homedata.data!.allCategoryDetails!.length > 0)
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: /*Color(0xFFD2E8FE)*/ /*ColorCodes.lightBlueColor*/ ColorCodes
                            .backgroundcolor),
            ...
            : Vx.isWeb
                ? SizedBox.shrink()
                : /*expandebelCatShimmer()*/ SizedBox.shrink()
        /*},
    )*/
        : /*StreamBuilder(
      stream: catbloc.catblostream,
                  ...
                  children: [
                    CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => Image.asset(
                        Images.defaultCategoryImg,
                        height:
                            ResponsiveLayout.isSmallScreen(context) ? 70 : 100,
                        width:
                            ResponsiveLayout.isSmallScreen(context) ? 100 : 130,
                        fit: BoxFit.fill,
                      ),
                    ...
                    Expanded(
                      ...
                      style: TextStyle(
                          fontSize:
                              ResponsiveLayout.isSmallScreen(context) ? 13 : 17,
                          fontWeight: FontWeight.bold),
                    )),
                    VerticalDivider(
                      color: Colors.white,
