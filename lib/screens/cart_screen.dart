          ...
          if (prev == "address_screen") {
            ...
            if (addressdata!.billingAddress!.length > 0) {
                ...
                prefs.setString(
                    "addressId",
                    addressdata!.billingAddress![0].id.toString());
                if(!Features.ismultivendor)calldeliverslots(addressdata!.billingAddress![0].id.toString());
                deliveryCharge(addressdata!.billingAddress![0].id.toString());
             // _Load=false;
            } else {
                _checkaddress = false;
            ...
            if(snapshot.length <= 0){
              ...
              return Column(
                ...
                children: [
                  ...
                  // Container(
                  //   color:  !Features.ismultivendor?ColorCodes.appdrawerColor:ColorCodes.whiteColor,
                  //   height: 10,
                  // ),
                          ...
                          child:Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 19,
                                    color: !Features.ismultivendor? ColorCodes.greenColor: ColorCodes.blackColor,
                                    fontWeight: FontWeight.bold),
                              ),
                              Text(
                                          ...
                                          children: <Widget>[
                                            Row(
                                              children: [
                                                ...
                                                // SizedBox(width: 10,),
                                                Text(
                                                  "Order will be deliverd to",//"Select delivery address",
                                                  style: TextStyle(
                                                      fontWeight: FontWeight.bold,
                                                      fontSize: 16.0,
                                                      color: ColorCodes.blackColor),
                                                  ...
                                                  children: [
                                                   // SizedBox(width: ,),
                                                    Expanded(
                                                      child: Row(
                                                        children: [
                                                          Image.asset(Images.homeConfirm,
                                                            height: 30,
                                                            width: 30,
                                                            color: ColorCodes.blackColor,
                                                          ),
               ...
               padding: EdgeInsets.only(left: 10.0, right: 10.0,bottom:10 ),
                  ...
                  child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left:10.0,right:5,bottom: 5, top:10),
                            child: Text("Almost There", style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 14.0,
                            color: ColorCodes.blackColor)),
                          ),
                        Padding(
                          padding: const EdgeInsets.only(left:10.0,right:5,bottom: 5, top:10),
                          child: Text("Add address so that we can deliver it to your location", style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 12.0,
                              color: ColorCodes.blackColor)),
                        ),
                        ...
                        Navigation(context, name: Routename.AddressScreen, navigatore: NavigatoreTyp.Push,
                              qparms: {
                                ...
                                child:  Container(
                                  width: (MediaQuery.of(context).size.width - 20), //330,
                                  height: 45,
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(5.0),
                                    border: Border.all(
                 ...
                 Container(
                  ...
                  //                         context) ?
                  //                     (Features.isSubscription) ? 250 : 244 :
 ...
 /*   void launchWhatsapp({required number,required message})async{
    ...
    gradientappbarmobile() {
      ...
      return AppBar(
        ...
        title: Text(
            (IConstants.isEnterprise && Features.ismultivendor)?IConstants.storename.toString(): "Checkout",// 'My Basket',
          style: TextStyle(fontWeight: FontWeight.bold,color: ColorCodes.iconColor),
        ),
        titleSpacing: 0,
