...
class CategoryScreen extends StatefulWidget {
  ...
  static GlobalKey<ScaffoldState> categoryScaffoldKey =
  ...
  Widget build(BuildContext context) {
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigation(context,
                      /*name:Routename.Home,*/ navigatore:
                      ...
                      SignupSelectionScreen.routeName,
                        ...
                        : (Features.isLiveChat && Features.isWhatsapp)
                            ...
                            : (!Features.isLiveChat && !Features.isWhatsapp)
                                ...
                                : Features.isWhatsapp
                                    ? launchWhatsApp() /*launchWhatsapp(number: IConstants.countryCode + IConstants.secondaryMobile, message:"I want to order Grocery")*/ : Navigator
                                            .of(context)
                                        .pushNamed(
                                            CustomerSupportScreen.routeName,
                                            arguments: {
    ...
    return ResponsiveLayout.isSmallScreen(context)
        ? Scaffold(
            ...
            //           child: CustomBottomNavigationBar(openDrawer: (){
