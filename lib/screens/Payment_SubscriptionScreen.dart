  ...
  Widget build(BuildContext context) {
            ...
            if (_isWallet)
             (_ischeckboxshow)
              ...
              child: Container(
                ...
                padding: EdgeInsets.only(left: 9, top: 20, right: 9, bottom: 20),
                child: Row(
                  //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
      ...
      Widget paymentSelection() {
        return Container(
          ...
          child: Column(
           ...
           // crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              (Vx.isWeb && !ResponsiveLayout.isSmallScreen(context)) ?SizedBox(height: 20,): SizedBox(height: 0,),
              Container(
                  width:  (Vx.isWeb && !ResponsiveLayout.isSmallScreen(context)) ?
    ...
    return WillPopScope(
      ...
      child: Scaffold (
        ...
        bottomNavigationBar:
        Vx.isWeb ? SizedBox.shrink() : _buildBottomNavigationBar(),
      ),
    );
  }
        ...
        if(_ischeckbox && _groupValue == -1){
          ...
          Navigation(context, name: Routename.SubscriptionConfirm, navigatore: NavigatoreTyp.Push,
            ...
            payment.startPaytmTransaction(
                context, Vx.isWeb, orderId: orderId.toString(),
