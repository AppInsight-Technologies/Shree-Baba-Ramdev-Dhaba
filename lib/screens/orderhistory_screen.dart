...
import '../widgets/invoice/invoice_button.dart';
...
class _OrderhistoryScreenState extends State<OrderhistoryScreen>
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      BrandItemsList()
          .GetRestaurantNew(PrefUtils.prefs!.getString("branch")!, () async {});
      ...
      Provider.of<MyorderList>(context, listen: false)
        ...
        setState(() {
          ...
          print("due amount..." +
              orderitemData.vieworder[0].dueamount.toString());
          if (orderitemData.vieworder1[0].deliveryOn != "") {
            ...
            for (int i = 0; i < orderitemData.vieworder1.length; i++) {
              ...
              print("jdffff" +
                  orderitemData.vieworder1[i].returnTime.toString() +
                  " " +
                  orderAdd.toString());
              if ((orderAdd.isAtSameMomentAs(today) ||
                ...
                if (orderitemData.vieworder1[i].returnTime != "" &&
                  ...
                  print("_showReturn" + _showReturn.toString());
                  break;
                }
              }
          ...
          if (prev == "splashNotification" ||
            ...
            Provider.of<NotificationItemsList>(context, listen: false)
                .updateNotificationStatus(
                    /*routeArgs['notificationId']*/ widget.notificationId, "1");
          }
          if ((prev == "splashNotification" &&
                  orderitemData.vieworder[0].ostatus.toString().toUpperCase() ==
                      "DELIVERED") ||
              (prev ==
                      "pushNotificationScreen" && /*routeArgs['notificationStatus']*/ widget
                          .notificationStatus ==
                      "0" &&
                  orderitemData.vieworder[0].ostatus.toString().toUpperCase() ==
                      "DELIVERED")) {
              ...
              if (_isWeb)
                Footer(
                    address: PrefUtils.prefs!.getString(
                        "restaurant_address")! /*PrefUtils.prefs!.getString("restaurant_address")*/),
            ],
          ),
        ),
      ),
  ...
  Widget viewOrder() {
    ...
    if (orderitemData.vieworder[0].itemodelcharge != 0) {
      total = double.parse(orderitemData.vieworder[0].itemoactualamount) +
          ...
          orderitemData
              .vieworder[0].loyalty /*- orderitemData.vieworder[0].wallet*/
          -
    ...
    subtotal = double.parse(orderitemData.vieworder[0].itemoactualamount) +
        double.parse(orderitemData.vieworder[0].dueamount);
    print(
        "total discoun" + orderitemData.vieworder[0].totalDiscount.toString());
    print("total amount" + subtotal.toString());
    print(
        "invoice number....." + orderitemData.vieworder[0].invoice.toString());
    String total_saving = (orderitemData.vieworder[0].promocode_discount +
            orderitemData.vieworder[0].membership_earned)
        .toString();
    print("jecvddfvfd " + Features.isReturnOrExchange.toString());
    return Align(
      alignment: Alignment.center,
      child: Container(
        constraints: (Vx.isWeb  && !ResponsiveLayout.isSmallScreen(context))
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Spacer(),
                      Text(orderitemData.vieworder[0].resturantname),
                    ],
                  ),
                  SizedBox(
                    height: 10,
                            ...
                            : IConstants.currencyFormat +
                                ...
                                total.toStringAsFixed(
                                    IConstants.numberFormat == "1"
                                        ? 0
                                        : IConstants.decimaldigit),
                        /*orderitemData.vieworder[0].itemototalamount,*/
                        style: TextStyle(fontWeight: FontWeight.bold
            ...
            if (Features.isRefundModule)
              if (dueamount > 0) SizedBox(height: 30),
            if (Features.isRefundModule)
              if (dueamount > 0)
                Container(
                  width: MediaQuery.of(context).size.width - 20,
                    ...
                    children: [
                      ...
                      arguments: {
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.centerLeft,
                          decoration:
                              BoxDecoration(color: ColorCodes.lightgreen),
                          height: 45,
                          // padding: const EdgeInsets.fromLTRB(15.0, 5.0, 15.0, 5.0),
                          child: Row(
                            children: [
