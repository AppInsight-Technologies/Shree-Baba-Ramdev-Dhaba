...
class _ItemsScreenState extends State<ItemsScreen>
  ...
  _displayitem(String catid, int index, int type, String initial) {
    ...
    productController.getCategoryprodutlist(catid, initial, type,
        (isendofproduct) {
      setState(() {
        isLoading = false;
        indvalue = index.toString();
        ...
        Future.delayed(Duration.zero, () async {
          ...
          ProductRepo().getSubNestcategory(subcatId.toString()).then((value) {
            setState(() {
              ...
              ListofNest = value
                  .where((element) =>
                      element.categoryName!.toLowerCase().trim() != "all")
                  .toList();
            ...
            _displayitem(
                subcatId.toString(),
                ListofNest.length > 0
                    ? int.parse(/*"0"*/ indvalue!) + 1
                    : (_nosub == "true" &&
                            VxState.store.homescreen.data!
                                    .allCategoryDetails![index].categoryType ==
                                0)
                        ? int.parse("0")
                        : int.parse(/*"0"*/ indvalue!) + 1,
                0,
  ...
  Widget itemsWidget() {
    ...
    int widgetsInRow =
        (kIsWeb && !ResponsiveLayout.isSmallScreen(context)) ? 2 : 1;
                                ...
                                child: GridView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return SellingItemsv2(
                                        ...
                                        returnparm: {
                                          'maincategory':
                                              widget.params['maincategory']!,
                                          'catId': catId!,
                                          'catTitle':
                                              widget.params['catTitle']!,
                                          'subcatId': subcatId,
                                          'indexvalue':
                                              widget.params['indexvalue']!,
                ...
                children: <Widget>[
                    ...
                    title: Row(
                      children: [
                        Container(
                          ...
                          child: Text(S.current.all_product,
                              style: TextStyle(
                  ...
                  ListTile(
                    ...
                    title: Row(
                      children: [
                        Container(
                          child: Text(S.current.express_delivery,
                              style: TextStyle(
                                  color: ColorCodes.blackColor,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold)),
        ...
        title: Column(
          ...
          children: [
            Text(
              indvalue == null
                  ? maincategory
                  : nestedCategory[int.parse(indvalue!)].categoryName!,
            ...
            Text(
                indvalue == null
                    ? ''
                    : nestedCategory[int.parse(indvalue!)].description!,
                style: TextStyle(color: ColorCodes.iconColor, fontSize: 14))
          ],
        ),
        leading: IconButton(
        ...
        actions: [
          ...
          MouseRegion(
            ...
            child: GestureDetector(
              onTap: () {
                Navigation(context,
                    navigatore: NavigatoreTyp.Push, name: Routename.search);
              },
              child: Container(
      ...
      return NotificationListener<ScrollNotification>(
        ...
        onNotification: (ScrollNotification scrollInfo) {
          if (!endOfProduct) if (!_isOnScroll &&
            ...
            productController.getCategoryprodutlist(
                subCategoryId,
                (VxState.store as GroceStore).productlist.length,
                subcatType, (isendofproduct) {
        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            Container(
              padding: EdgeInsets.only(
                  left: (kIsWeb && !ResponsiveLayout.isSmallScreen(context))
                      ? 28
                      : 0),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
...
//                            textAlign: TextAlign.center,
                  ...
                  print("nested categoy name..."+nestedCategory[0].categoryName.toString());*/
                        ...
                        nestedCategory =
                            store!.homescreen.data!.allCategoryDetails!
                                .where((element) {
                                  print(
                                      "parent id.......${element.id}==$parentcatid");
                                  return element.id == parentcatid;
                                })
                                .first
                                .subCategory;
...
//                            textAlign: TextAlign.center,
                ...
                Expanded(
                  child: NotificationListener<ScrollNotification>(
                      ...
                      onNotification: (ScrollNotification scrollInfo) {
                        if (!endOfProduct) if (!_isOnScroll &&
                          ...
                          productController.getCategoryprodutlist(
                              ...
                              (VxState.store as GroceStore).productlist.length,
                              subcatType, (isendofproduct) {
                            startItem = (VxState.store as GroceStore)
                                .productlist
                                .length;
                            endOfProduct = isendofproduct;
                            if (endOfProduct) {
                      ...
                      child: SingleChildScrollView(
                          scrollDirection: Axis.vertical, child: _body())),
                ),
              ],
            ),
