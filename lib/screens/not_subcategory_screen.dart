...
class _NotSubcategoryScreenState extends State<NotSubcategoryScreen>
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      if (/*routeArgs['fromScreen']*/ widget.fromscreen == "ClickLink") {
        ...
        if (/*routeArgs['notificationStatus']*/ widget.notificationStatus ==
            "0") {
          Provider.of<NotificationItemsList>(context, listen: false)
              .updateNotificationStatus(
                  /*routeArgs['notificationId']!*/ widget.notificationId, "1")
      ...
      Provider.of<NotificationItemsList>(context, listen: false)
          .fetchCategoryItems(subcategoryId)
          .then((_) {
        subcategoryData =
            Provider.of<NotificationItemsList>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return _isNotification
        ? WillPopScope(
            onWillPop: () {
              if (/*routeArgs['fromScreen'] */ widget.fromscreen ==
                  "ClickLink") {
              ...
              '/home-screen', (Route<dynamic> route) => false);*/
                ...
                Navigation(context,
                    navigatore: nav.NavigatoreTyp.PushReplacment,
            ...
            child: Scaffold(
              appBar: NewGradientAppBar(
                gradient: LinearGradient(
                    ...
                    colors: [ColorCodes.appbarColor, ColorCodes.appbarColor2]),
