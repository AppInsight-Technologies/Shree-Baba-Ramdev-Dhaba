...
//  Box<Product> productBox;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      print("delivery amt payment screen..."+deliveryAmt.toString());
 ...
 fetchUserDetail()async{
   ...
   setState(() {
     ...
     if (membershipvx == "1" ||_checkmembership) {
       print("cart tota......payment"+cartTotal.toString());
...
//      resBody["membership"] = PrefUtils.prefs!.getString('fixtime');
    ...
    resBody["ref"] = Features.ismultivendor?IConstants.refIdForMultiVendor.toString():"";
    resBody["branchtype"] = Features.ismultivendor?IConstants.branchtype.toString():"";
    resBody["loyalty"] =
    ...
    (loyaltyData.itemsLoyalty.length > 0) ? loyaltyData.itemsLoyalty[0].points
        .toString() : "0";
    resBody["version"] = Vx.isWeb ? "web 1.0.0" : packageInfo!.version + "+" +
    ...
    for (int i = 0; i < productBox.length; i++) {
        ...
        if (double.parse(productBox[i].varStock!) > 0 &&
          ...
          if (index != "") {
            if (int.parse(index) == i) {}
              ...
              resBody["items["+i.toString()+"][package]"] = "0";

              resBody["items["+i.toString()+"][packageVarId]"] = "0";

              resBody["items["+i.toString()+"][packageMenuId]"] = "0";
      ...
      if (responseJson['status'].toString() == "true") {
        ...
        if (PrefUtils.prefs!.getString('payment_type') == "paytm") {
          ...
          await payment.startPaytmTransaction(context, Vx.isWeb,
              orderId: orderdecode['id'].toString(),
...
//      resBody["membership"] = PrefUtils.prefs!.getString('fixtime');
      ...
      resBody["version"] = Vx.isWeb ? "web 1.0.0" : packageInfo!.version + "+" + packageInfo!.buildNumber;
        ...
        if (PrefUtils.prefs!.getString('payment_type') == "paytm") {
          ...
          // }else {
            payment.startPaytmTransaction(
                context, Vx.isWeb, orderId: orderdecode['ref_id'].toString(),
                username: PrefUtils.prefs!.getString('userID'),
                amount: orderAmount,
    ...
    child:Scaffold (
      ...
      body: Column(
        children: [
          ...
          (Vx.isWeb && !ResponsiveLayout.isSmallScreen(context)) ? _bodyWeb()! : _bodyMobile(),
