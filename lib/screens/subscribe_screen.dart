 ...
 // bool loader =true;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      print("sub type...."+widget.type.toString());
      ...
      SubscriptionApi.getSubscriptionPromoplan(ParamBodyData(branchtype: IConstants.isEnterprise && Features.ismultivendor?IConstants.branchtype.toString():"",
        ...
        _futureSubscriptionPromoplan.then((value) {
          if( value.status == 200 ){
            ...
            deliveryNum =    value.data![0].isdefault =="1" ?100:int.parse(value.data![0].days!);
...
/*    var finalDa;
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return GestureDetector(
                                    onTap: (){
                                      ...
                                      deliveryNum =    SubscriptionPromoplan.data![index].isdefault =="1" ?100:int.parse(SubscriptionPromoplan.data![index].days!);
                                    },
                                    child: Column(
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            //IConstants.currencyFormat+SubscriptionPromoplan.data![index].discountAmount!
                                            SubscriptionPromoplan.data![index].isdefault =="1" ?
                                            Text("Regular Subscription", style: TextStyle(
                                                fontSize: 12,
                                                fontWeight: FontWeight.bold
                                            ),):
                                            Column(
  ...
  Future<void> CreateSubscription() async {
    ...
    // try {
      double total= ((_itemCount * TotalAmount!));
      List<String> weeks  = [];
      SelectedWeek.map((e) => weeks.add(e.weekname)).toList();
      ...
      final response = await http.post(Api. subscriptionCreate, body: {
        ...
        "address_id":/*routeArgs['addressid'].toString()*/user_data.billingAddress![0].id.toString(),
        ...
        "planId": planId,
       "paymentMode": paymentMode.toString(),
        "walletBalance": walletAmount.toString(),
        "only_wallet": "1",
