...
Navigation(context, navigatore: NavigatoreTyp.homenav);
                  ...
                  Text(
                    S .of(context).search_product,//"Search Products",
                    style: TextStyle(color: ColorCodes.iconColor, fontSize: 18.0),
                  )
                ],
              ),
              Container(
  ...
  Widget _ListSerchItem([AsyncSnapshot<List<ItemData>>? snapshot]) {
    ...
    (deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 310 :  (!Features.ismultivendor) ? (deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 170 : (deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 140;
