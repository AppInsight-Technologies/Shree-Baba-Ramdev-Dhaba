...
class CartRepo{
  ...
  Future<List<CartItem>> getCart(Function(List<CartItem>) loading) async{
    ...
    json.decode(await api.Geturl("v3/get-cart-items-vendor/${PrefUtils.prefs!.containsKey("apikey")?PrefUtils.prefs!.getString("apikey"):PrefUtils.prefs!.getString("ftokenid")}/${IConstants.refIdForMultiVendor}",isv2: false))
        :
