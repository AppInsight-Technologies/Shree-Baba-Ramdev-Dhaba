    ...
    if (PrefUtils.prefs!.containsKey("apikey")) {
      ...
      final resp = UserModle.fromJson(json.decode(await api.Geturl(
          ...
          "customer/get-profile?apiKey=${PrefUtils.prefs!.getString(
              "apikey")}&branchtype=${ (Features.ismultivendor && IConstants.isEnterprise) ?IConstants.branchtype.toString():""}&branch=${PrefUtils.prefs!.getString("branch")}&ref=${ (Features.ismultivendor && IConstants.isEnterprise) ?IConstants.refIdForMultiVendor:""}"
              /*:"customer/get-profile?apiKey=${PrefUtils.prefs!.getString(
