...
class CartController{
  ...
  update(Function(bool) onload,{required String price,required String quantity,required String weight,required String var_id,String? type,String? increament, required String cart_id,String? toppings, String? topping_id}){
    print("hello....");
  onload(false);
  _cart.updateCart({
    ...
    "toppings_id": (topping_id! == "null")?"":topping_id
      ...
      if(value){
        SetCartItem(CartTask.update,quantity: quantity,weight:weight,varid: var_id,skutype:type,parent_id:cart_id,onloade: (value){
          onload(true);
        });
        if(quantity!="0")
  ...
  newproduct, required List toppingsList,StoreSearchData? storeSearchData,PriceVariation? itembody,PriceVariationSearch? itembodysearch,String? fromScreen,required BuildContext context}) {
...
class SetCartItem extends VxMutation<GroceStore>{
  ...
  String? skutype;
  String? parent_id;
  SetCartItem(this.type, {this.quantity,this.weight,this.varid,required this. onloade, this.data,this.skutype,this.parent_id});
  @override
  perform() async{
